...
//         // public ValueTask<Interfaces.HttpResponseMessageIO> GetAsync(string requestUri) =>
//         //     _client.GetAsync(requestUri).Map(r => (Interfaces.HttpResponseMessageIO)new HttpResponseMessageIO(r)).ToValue();
